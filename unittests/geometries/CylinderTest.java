...
class CylinderTest {
    ...
    void testGetNormal() {
        ...
        Point pOffTheSurface = new Point(1, 10, -5);
        ...
        assertThrows(IllegalArgumentException.class, () -> c1.getNormal(pOriginalPoint),
        ...
        assertThrows(IllegalArgumentException.class, () -> c1.getNormal(pOnTheAxis),
                "does not throw exception when point is not on the tube");
        assertThrows(IllegalArgumentException.class, () -> c1.getNormal(pOffTheSurface),
                "does not throw exception when point is not on the tube");
